...
class CatalogController extends Controller
{
    ...
    //     }
    //     $categoryarray=[];
    //     $category2 =  Category::whereIn('name',['vault','b2b'])->get() ;
    ...
    //      if($user->b2bstatus==1)
    //     {
    //         $category =  Category::where('name','b2b')->first() ;
    //        // dd($category);
           
    //     }
    //     else  if($user->vault==1)
    //     {
    //         $category =  Category::where('name','vault')->first() ;
    //     }
    //      else if($request->category!=='b2b' or $request->category!=='vault' )
    //     {
    ...
    //     }
    //     else{
    //         $category =  Category::whereNotIn('name','vault')->firstOrFail();
    //        // dd($category);
    ...
    //     ->when($categoryarray, function ($query, $categoryarray) {
    //         $user = Auth::user();
    //         if($user->vault==0 and $user->b2bstatus==0)
    //         {
    //         return $query->whereNotIn('category_id', $categoryarray);
    //         }

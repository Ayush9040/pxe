    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title"><b>{{ __('Premium Categories') }}</b></h3>
                <a class="btn btn-primary  btn-sm" href="{{route('back.premiumcategory.create')}}"><i class="fas fa-plus"></i> {{ __('Add') }}</a>
                </div>
        </div>
    </div>

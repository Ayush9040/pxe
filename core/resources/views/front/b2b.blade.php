            ...
            <div class="row">
                    ...
                    <div class="">
                        <div>
                         ...
                         <div class="col-md-12 pt-5">
                            ...
                            <div class="col-md-8">
                             <form action="{{route('user.login.submit')}}" class="" method="post"><span class="input-group-btn">
                             @csrf
                                <div class="form-group">
                                    <label for="reg-email" class="text-u log-text-b2b">{{__('E-mail')}}</label>
                                    <input class="form-control w-100 border-0" type="email" name="email" placeholder="" id="reg-email" value="{{old('email')}}">
                                    @error('email')
                                    <p class="text-danger">{{$message}}</p>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <label for="reg-pass" class="text-u log-text-b2b">{{__('Password')}}</label>
                                ...
                                <div class="text-center ">
                                    <button class="btn btn-primary margin-bottom-none b2b-log-btn mb-4" type="submit" style="color: #06FF00 !important;font-size: 19px;"><span style="color: #06FF00 !important;">{{ __('submit') }}</span></button>
                                </div>
                                <!--<div>-->
                ...
                <!-- <div class="col-md-4">
                    <div class="img-cent content-padd">
                        <img src="{{asset('assets/images/b2b.png')}}" alt="" style="display:none">
                    </div>
                </div> -->
            </div>
            <div class="row mt-30">

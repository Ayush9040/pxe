  ...
  <div class="container padding-bottom-1x mb-3 my-3">
      ...
      <div class="accordion" id="accordion1">
        <div class="card accordion-item mb-4">
            ...
            <div id="collapse{{$key}}" class="accordion-collapse collapse uppercase"  aria-labelledby="heading{{$key}}" data-bs-parent="#accordion1">
              <div class="card-body uppercase">{{$faq->details}}</div>
            </div>
          </div>
        </div>
        @endforeach

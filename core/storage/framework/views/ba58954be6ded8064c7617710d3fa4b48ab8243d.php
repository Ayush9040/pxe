    ...
    <div class="row">
      ...
      <div class="col-xl-9 col-lg-8">
        <div class="steps flex-sm-nowrap mb-5"> <a class="step" href="<?php echo e(route('front.checkout.billing')); ?>">
          <h4 class="step-title  uppercase"><i class="icon-check-circle"></i>1. <?php echo e(__('Invoice to')); ?>:</h4>
          </a> <a class="step" href="<?php echo e(route('front.checkout.shipping')); ?>">
          <h4 class="step-title uppercase"><i class="icon-check-circle"></i>2. <?php echo e(__('Ship to')); ?>:</h4>
        ...
        <div class="card">
            <div class="card-body">
                <h6 class="pb-2 uppercase"><?php echo e(__('Review Your Order')); ?> :</h6>
        <hr>
        <div class="row padding-top-1x  mb-4">
          <div class="col-sm-6">
            <h6 class="uppercase"><?php echo e(__('Invoice address')); ?> :</h6>
            <?php
            ...
            <ul class="list-unstyled">
              <li><span class="text-muted uppercase"><?php echo e(__('Name')); ?>: </span><?php echo e($ship['ship_first_name']); ?> <?php echo e($ship['ship_last_name']); ?></li>
              <?php if(PriceHelper::CheckDigital()): ?>
              <li><span class="text-muted uppercase"><?php echo e(__('Address')); ?>: </span><?php echo e($ship['ship_address1']); ?> <?php echo e($ship['ship_address2']); ?></li>
              <?php endif; ?>
              <li><span class="text-muted uppercase "><?php echo e(__('Phone')); ?>: </span><?php echo e($ship['ship_phone']); ?></li>
            </ul>
          </div>
          <div class="col-sm-6">
            <h6 class="uppercase"><?php echo e(__('Shipping address')); ?> :</h6>
            <ul class="list-unstyled">
              <li><span class="text-muted uppercase"><?php echo e(__('Name')); ?>: </span><?php echo e($bill['bill_first_name']); ?> <?php echo e($bill['bill_last_name']); ?></li>
              <?php if(PriceHelper::CheckDigital()): ?>
              <li><span class="text-muted uppercase"><?php echo e(__('Address')); ?>: </span><?php echo e($ship['ship_address1']); ?> <?php echo e($ship['ship_address2']); ?></li>
              <?php endif; ?>
              <li><span class="text-muted uppercase"><?php echo e(__('Phone')); ?>: </span><?php echo e($bill['bill_phone']); ?></li>
            </ul>

            <?php if(DB::table('states')->whereStatus(1)->count() > 0): ?>
            <select name="state_id" class="form-control uppercase" id="state_id_select" required>
              <option class="uppercase" value="" selected disabled><?php echo e(__('Select Shipping State')); ?></option>
            ...
            <small class="text-primary uppercase"><?php echo e(__('please select shipping state')); ?></small>
          ...
          <div class="col-12">
            <div class="payment-methods">
              ...
              <div class="single-payment-method">
                <a class="text-decoration-none uppercase" href="#" data-bs-toggle="modal" data-bs-target="#<?php echo e($gateway->unique_keyword); ?>">
                    <img class="" src="<?php echo e(asset('assets/images/'.$gateway->photo)); ?>" alt="<?php echo e($gateway->name); ?>" title="<?php echo e($gateway->name); ?>">
                    <p class="uppercase"><?php echo e($gateway->name); ?></p>
                </a>
              </div>
              <?php endif; ?>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/front/checkout/payment.blade.php ENDPATH**/ ?>
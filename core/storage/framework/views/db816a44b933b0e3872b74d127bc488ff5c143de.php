<ul class="nav">
    ...
    <li class="nav-item">
        <a href="<?php echo e(route('back.dashboard')); ?>">
            ...
            <p class="uppercase"><?php echo e(__('Dashboard')); ?></p>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#category">
            ...
            <p class="uppercase"><?php echo e(__('Manage Categories')); ?></p>
            ...
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.category.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Categories')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.subcategory.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Sub categories')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.childcategory.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Child categories')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.premiumcategory.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Premium categories')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#items">
            ...
            <p class="uppercase"><?php echo e(__('Manage Products')); ?></p>
            <span class="caret"></span>
        </a>
            ...
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.brand.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Brands')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.item.add')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Add Product')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.item.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('All Products')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.item.stock.out')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Stock Out Products')); ?></span>
                    </a>
                </li>
                <!--<li>-->
    ...
    <li class="nav-item <?php echo e(request()->is('orders/*') ? 'submenu' : ''); ?>">
        <a data-toggle="collapse" href="#order">
            ...
            <p class="uppercase"><?php echo e(__('Manage Orders')); ?> </p>
            <span class="caret"></span>
        </a>
            ...
            <ul class="nav nav-collapse">
                <li class="<?php echo e(!request()->input('type') && request()->is('admin/orders')  ? 'active' : ''); ?>">
                    <a class="sub-link" href="<?php echo e(route('back.order.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('All Orders')); ?></span>
                    </a>
                </li>
                <li class="<?php echo e(request()->input('type') == 'Pending' ? 'active' : ''); ?>">
                    <a class="sub-link" href="<?php echo e(route('back.order.index').'?type='.'Pending'); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Pending Orders')); ?></span>
                    </a>
                </li>
                <li class="<?php echo e(request()->input('type') == 'In Progress' ? 'active' : ''); ?>">
                    <a class="sub-link" href="<?php echo e(route('back.order.index').'?type='.'In Progress'); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Progress Orders')); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php echo e(request()->input('type') == 'Delivered' ? 'active' : ''); ?>">
                    <a class="sub-link" href="<?php echo e(route('back.order.index').'?type='.'Delivered'); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Delivered Orders')); ?></span>
                    </a>
                </li>
                <li class="<?php echo e(request()->input('type') == 'Canceled' ? 'active' : ''); ?>">
                    <a class="sub-link" href="<?php echo e(route('back.order.index').'?type='.'Canceled'); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Canceled Orders')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#bundle">
            <i class="fas fa-list-alt"></i>
            <p class="uppercase"><?php echo e(__('Manage Bundles')); ?></p>
            <span class="caret"></span>
        </a>
        <div class="collapse" id="bundle">
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.category.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Add Bundle Categories')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.subcategory.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Add Bundle Product')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.childcategory.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('All Bundle Products')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="nav-item">
        <a  href="<?php echo e(route('back.transaction.index')); ?>">
          ...
          <p class="uppercase"><?php echo e(__('Transactions')); ?></p>
        </a>
    </li>
    <?php endif; ?>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#ecommerce">
            ...
            <p class="uppercase"><?php echo e(__('Ecommerce')); ?></p>
            <span class="caret"></span>
        </a>
            ...
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.code.index')); ?>">
                      <span class="sub-item uppercase"><?php echo e(__('Set Coupons')); ?></span></a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.shipping.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Shipping')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.state.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('State Tax')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.tax.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Tax')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.currency.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Currency')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.setting.payment')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Payment')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
   ...
   <?php if(in_array('Customer List',$section)): ?>
      <li class="nav-item">
        <a href="<?php echo e(route('back.user.index')); ?>">
          ...
          <p class="uppercase"><?php echo e(__('Customer List')); ?></p></a>
    </li>
    <?php endif; ?>
    <?php if(in_array('Customer List',$section)): ?>
      <li class="nav-item">
        <a href="<?php echo e(route('back.b2b.index')); ?>">
          <i class="fas fa-users"></i>
          <p class="uppercase"><?php echo e(__('B2B Customer List')); ?></p></a>
    </li>
    <?php endif; ?>
    <?php if(in_array('Customer List',$section)): ?>
      <li class="nav-item">
        <a href="<?php echo e(route('back.vault.index')); ?>">
          <i class="fas fa-users"></i>
          <p class="uppercase"><?php echo e(__('VAULT Customer List')); ?></p></a>
    </li>
    <?php endif; ?>
    ...
    <!-- <?php if(in_array('Customer List',$section)): ?> -->
      <!-- <li class="nav-item">
        <a href="<?php echo e(route('back.franchise.index')); ?>">
          <i class="fas fa-users"></i>
          <p><?php echo e(__('Franchise')); ?></p></a>
    </li> -->
    <!-- <?php endif; ?> -->
    ...
    <!-- <li class="nav-item">
                    ...
                    <i class="fas fa-users"></i>
                        <p class="sub-item"><?php echo e(__('Sliders')); ?></p>
                    </a>
                </li> -->
    ...
    <li class="nav-item">
        <a href="<?php echo e(route('back.ticket.index')); ?>">
          ...
          <p class="uppercase"><?php echo e(__('Manages Tickets')); ?></p></a>
    </li>
    <?php endif; ?>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#content">
            ...
            <p class="uppercase"><?php echo e(__('Manage Site')); ?></p>
            <span class="caret"></span>
        </a>
            ...
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.setting.system')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('General Settings')); ?></span>
                    </a>
                </li>
                <li>
                  <a class="sub-link" href="<?php echo e(route('back.homePage')); ?>">
                     <span class="sub-item uppercase"><?php echo e(__('Home Page')); ?></span>
                   </a>
               </li>
                <li>
                    <a  class="sub-link" href="<?php echo e(route('back.slider.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Sliders')); ?></span>
                    </a>
                </li>
                <li>
                    <a  class="sub-link" href="<?php echo e(route('back.exclusive.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Exclusive deals')); ?></span>
                    </a>
                </li>
                <!--<li>-->
                ...
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.setting.social')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Social Login')); ?></span>
                    </a>
                </li>

                <li>
                    <a class="sub-link" href="<?php echo e(route('back.setting.email')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Email Settings')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.setting.sms')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('SMS Settings')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.subscribers.announcement')); ?>">
                      <span class="sub-item uppercase"><?php echo e(__('Announcement')); ?></span></a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.cookie.alert')); ?>">
                      <span class="sub-item uppercase"><?php echo e(__('Cookies Alert')); ?></span></a>
                </li>

                <li>
                    <a class="sub-link" href="<?php echo e(route('back.setting.maintainance')); ?>">
                      <span class="sub-item uppercase"><?php echo e(__('Maintainance')); ?></span></a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('admin.sitemap.index')); ?>">
                      <span class="sub-item uppercase"><?php echo e(__('Sitemap')); ?></span></a>
                </li>
                <!--<li>-->
                <!--    <a class="sub-link" href="<?php echo e(route('back.language.index')); ?>">-->
                <!--      <span class="sub-itemuppercase"><?php echo e(__('Language')); ?></span></a>-->
                <!--</li>-->
            </ul>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#faqs">
            ...
            <p class="uppercase"><?php echo e(__('Manage Faqs')); ?></p>
            <span class="caret"></span>
        </a>
            ...
            <ul class="nav nav-collapse">
                ...
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.faq.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Faqs')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#post">
            ...
            <p class="uppercase"><?php echo e(__('Manage Blogs')); ?></p>
            <span class="caret"></span>
        </a>
            ...
            <ul class="nav nav-collapse">
                ...
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.post.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Blogs')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.post.show')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Blogs List')); ?></span>
                    </a>
                </li>
                <!--<li>-->
                <!--    <a class="sub-link" href="<?php echo e(route('back.post.index')); ?>">-->
                <!--        <span class="sub-item"><?php echo e(__('Bloogs')); ?></span>-->
                <!--    </a>-->
                <!--</li>-->
            </ul>
        </div>
    ...
    <li class="nav-item">
        <a href="<?php echo e(route('back.page.index')); ?>">
            ...
            <p class="uppercase"><?php echo e(__('Manages Pages')); ?></p>
        </a>
    </li>
    <?php endif; ?>
    ...
    <li class="nav-item">
        <a href="<?php echo e(route('back.subscribers.index')); ?>">
            ...
            <p class="uppercase"><?php echo e(__('Subscribers List')); ?></p>
        </a>
    </li>
    <?php endif; ?>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#user">
            ...
            <p class="uppercase"><?php echo e(__('System User')); ?></p>
            <span class="caret"></span>
        </a>
            ...
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.role.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Role')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.staff.index')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('System User')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#backup">
            ...
            <p class="uppercase"><?php echo e(__('System Backup')); ?></p>
            <span class="caret"></span>
        </a>
            ...
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.system.backup')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('System Backup')); ?></span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="<?php echo e(route('back.database.backup')); ?>">
                        <span class="sub-item uppercase"><?php echo e(__('Database Backup')); ?></span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="nav-item">
        <a href="<?php echo e(route('front.cache.clear')); ?>">
            ...
            <p class="uppercase"><?php echo e(__('Cache Clear')); ?></p>
        </a>
    </li>

</ul>
<?php /**PATH D:\xampp\htdocs\pxe\core\resources\views/master/inc/normal.blade.php ENDPATH**/ ?>
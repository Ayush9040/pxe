...
<div class="slider-container">
    ...
    <?php if($setting->is_popular_category == 1): ?>
        <section class="newproduct-section popular-category-sec mt-40">
            <div class="px-4">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title" style="margin-bottom:0">
                            <h2 class="h3" style="color:red;padding:0px"><?php echo e($popular_category_title); ?></h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xxl-7 col-lg-6 col-md-6 fixing-btns">
            <div class="details-page-top-right-content d-flex">
                <div class="div w-100">
                    ...
                    <p class="text-muted uppercase" ><?php echo e($item->details); ?> 
...
<?php endif; ?>
    ...
    <div class="site-footer mt-40 mb-20" style="border-top: 1px solid #e5e5e5; ">
    <div class="">
      <div class="row"> 
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/front/themes/theme1.blade.php ENDPATH**/ ?>
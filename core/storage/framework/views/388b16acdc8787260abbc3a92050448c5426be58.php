    ...
    <div class="left-category-area">
        <div class="category-header">
            <h4 class="uppercase" style="background-color:#d3020e !important;color:#fff"><i class="icon-align-justify"></i> <?php echo e(__('Categories')); ?></h4>
        </div>
        <div class="category-list">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="c-item">
                    <a class="d-block navi-link uppercase" href="<?php echo e(route('front.catalog').'?category='.$pcategory->slug); ?>">
                        <img class="lazy" data-src="<?php echo e(asset('assets/images/'.$pcategory->photo)); ?>">
                        <span class="text-gray-dark uppercase"><?php echo e($pcategory->name); ?></span>
                    ...
                    <div class="sub-c-box">
                            ...
                            <div class="child-c-box">
                              <a class="title uppercase" href="<?php echo e(route('front.catalog').'?subcategory='.$scategory->slug); ?>">
        ...
        <a href="<?php echo e(route('front.catalog')); ?>" class="d-block navi-link view-all-category">
            ...
            <span class="text-gray-dark uppercase"><?php echo e(__('All Categories')); ?></span>
        </a>
    </div>
...
<?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/includes/categories.blade.php ENDPATH**/ ?>
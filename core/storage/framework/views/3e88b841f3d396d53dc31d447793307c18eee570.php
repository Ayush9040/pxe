        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xs-12">
                <div class="custom-card" style="text-align: left;">
                    ...
                    <p>Dear <?php echo e($data['name']); ?>,</p>
                    <p>Register Email <?php echo e($data['mail']); ?>,</p>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/emails/emailsenter.blade.php ENDPATH**/ ?>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group ">
                        <div class="row" style="padding-left:16px">
                            <input type="checkbox" name="hypayarn" id="hypayarn" class="form-control" value="1" <?php if($item->hypayarn==1): ?> <?php echo e(_('checked')); ?> <?php endif; ?> style="width:auto;margin-right:15px">
                            <label for="brand_id" style="padding-top:5px"><?php echo e(__('Material Hypoyarn')); ?> </label>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/back/item/edit.blade.php ENDPATH**/ ?>
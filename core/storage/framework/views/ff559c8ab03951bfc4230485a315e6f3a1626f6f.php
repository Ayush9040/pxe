	...
	<div class="wrapper">
		<div class="main-header " >
			...
			<div class="logo-header">
				...
				<img src="<?php echo e(asset('assets/images/logofooter.png')); ?>" style="width: 70%;" alt="">
				...
				<div class="navbar-minimize">
					<button class="btn btn-minimize " style="color:#fff !important">
						<i class="fa fa-bars"></i>
					</button>
				</div>
			</div>
				...
				<div class="container-fluid">
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<li class="nav-item mr-4">
							<a class="btn btn-sm btn-primary py-1 text-white uppercase" title="website" href="<?php echo e(route('front.index')); ?>" target="_blank">
			...
			<div class="sidebar-wrapper scrollbar-inner">
				<div class="sidebar-content">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									...
									<span class="user-level uppercase"><?php echo e(__('Administrator')); ?></span>
								</span>
							</a>
						</div>
					</div>
                    ...
                    <div class="sidebar-footer text-primary d-block text-center pt-3">
                        <span class="d-inline-block"><b></b></span>
                    </div>
...
<?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/master/back.blade.php ENDPATH**/ ?>
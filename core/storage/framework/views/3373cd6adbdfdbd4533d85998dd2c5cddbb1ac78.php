    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-md-7 col-sm-7 order-lg-2 order-md-1 order-sm-1">
        <div class="contact-form-box card">
            ...
            <h2 class="h4 content-box-title"><?php echo e(__('Tell Us Your Message :')); ?></h2>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raj/Desktop/dev/php/jkkmecom/core/resources/views/front/contact.blade.php ENDPATH**/ ?>
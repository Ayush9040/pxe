<?php if($sitem->item_type != 'affiliate'): ?>
    ...
    <a class="product-button add_to_single_cart uppercase"  data-target="<?php echo e($sitem->id); ?>" href="javascript:;"  title="<?php echo e(__('To Cart')); ?>"><i class="icon-shopping-cart"></i>
    </a>
    <?php else: ?>
...
<?php endif; ?><?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/includes/item_footer.blade.php ENDPATH**/ ?>
...
<div class="col-lg-4">
    <aside class="user-info-wrapper">
      <div class="user-info">
        ...
        <div class="user-data">
          <h4 class="h5"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h4><span><?php echo e($user->membership); ?></span><span><?php echo e(__('Joined')); ?> <?php echo e($user->created_at->format('M D Y')); ?></span>
        </div>
      </div>
...
<?php /**PATH /home/raj/Desktop/dev/php/jkkmecom/core/resources/views/includes/user_sitebar.blade.php ENDPATH**/ ?>
    ...
    <div class="left-category-area">
        <div class="category-header">
            <h4 style="background-color:#d3020e !important;color:#fff"><i class="icon-align-justify"></i> <?php echo e(__('Categories')); ?></h4>
        </div>
...
<?php /**PATH /home/raj/Desktop/dev/php/jkkmecom/core/resources/views/includes/categories.blade.php ENDPATH**/ ?>
...
<!--  </div>-->
  <!-- Page Content-->
  <div class="container padding-bottom-1x mb-3 my-3">
      ...
      <div class="accordion" id="accordion1">
        <div class="card accordion-item mb-4">
            ...
            <div id="collapse<?php echo e($key); ?>" class="accordion-collapse collapse uppercase"  aria-labelledby="heading<?php echo e($key); ?>" data-bs-parent="#accordion1">
              <div class="card-body uppercase"><?php echo e($faq->details); ?></div>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pxe\core\resources\views/front/faq/show.blade.php ENDPATH**/ ?>
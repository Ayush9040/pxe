...
<title>PXE</title>
<?php else: ?>
<title>PXE -<?php echo $__env->yieldContent('title'); ?></title>
<?php endif; ?>



<link rel="icon" type="image/png" href="<?php echo e(asset('assets/images/pxe_logo.png')); ?>">
...
<style>
    ...
    @font-face {
        font-family: 'myfont';
        src: url('<?php echo e(asset("assets/front/fonts/pxe.ttf")); ?>');
    }
...
<div class="header_slider" style="">
  ...
  <div class="searchBar">
    ...
    <a href="<?php echo e(route('front.b2b')); ?>" class="btn_portal_link"> <span class="b2b_portal">PORTAL</span></a>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        <!-- Logo-->
                        <div class="site-branding"><a class="site-logo align-self-center" href="<?php echo e(route('front.index')); ?>">
                            <img src="<?php echo e(asset('assets/images/pxe_logo.png')); ?>" alt="">
                        </a>
        ...
        ?>
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- <div class="c-item"> -->
                    ...
                    <option class="d-block navi-link" value="<?php echo e(route('front.catalog', ['category' => $pcategory->slug])); ?>">
        ...
        <div class="tab-pane fade show active" id="mmenu" role="tabpanel" aria-labelledby="mmenu-tab">
            <nav class="slideable-menu" style="background-color:#000">
                ...
                <li class="<?php echo e(request()->routeIs('front.contact') ? 'active' : ''); ?> menu-box-odd uppercase"><a href="<?php echo e(route('front.vault')); ?>"><?php echo e(__('Vault')); ?><i class="icon-chevron-right"></i></a></li>
                 <?php if(!Auth::user()): ?>
                <li class="<?php echo e(request()->routeIs('front.contact') ? 'active' : ''); ?> menu-box-even uppercase"><a href="<?php echo e(route('user.login')); ?>"><?php echo e(__('S')); ?><i class="icon-chevron-right"></i></a></li>
                <?php else: ?>
...
<?php /**PATH D:\xampp\htdocs\pxe\core\resources\views/master/front.blade.php ENDPATH**/ ?>
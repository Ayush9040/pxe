                            ...
                            <a href="<?php echo e(route('front.blog.details',$post->slug)); ?>" class="blog-post">
                                ...
                                <div class="post-body">
                                    ...
                                    <ul class="post-meta">
                                        ...
                                        <li>
                                        <!-- <a href="#"> -->
                                        <span><i class="fab fa-facebook-f" style=""></i></span>
                                        <span><i class="fab fa-twitter" style=""></i></span>
                                        <span><i class="fab fa-instagram" style=""></i></span>
                                    <!-- </a> -->
                                        </li>
                                        <!-- <li>
                                        <span><i class="fab fa-twitter" style=""></i></span>
                                        ...
                                        <li>
                                        <span><i class="fab fa-linkedin-in" style=""></i></span>
                                        </li> -->
                                    </ul>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raj/Desktop/dev/php/jkkmecom/core/resources/views/front/blog/index.blade.php ENDPATH**/ ?>
...
<!--  </div>-->
  <!-- Page Content-->
  <div class="padding-bottom-3x mb-1 my-3 px-4 border-bot">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="col-md-10 gd-text-sm-center">
                            <div class="sptfl">
                                <div class="quickFilter">
                                    <h4 class="quickFilter-title uppercase" style="font-weight:700"><i class="fas fa-filter"></i><?php echo e(__('Quick filter')); ?></h4>
                                    <ul id="quick_filter">
                                        <li><a datahref=""  class="uppercase"><i class="icon-chevron-right pr-2 "></i><?php echo e(__('All products')); ?> </a></li>
                                        <li class=""><a href="javascript:;" class="uppercase" data-href="feature"><i class="icon-chevron-right pr-2"></i><?php echo e(__('Featured products')); ?> </a></li>
                                        <li class=""><a href="javascript:;" class="uppercase" data-href="best"><i class="icon-chevron-right pr-2"></i><?php echo e(__('Best sellers')); ?> </a></li>
                                        <li class=""><a href="javascript:;" class="uppercase" data-href="top"><i class="icon-chevron-right pr-2"></i><?php echo e(__('Top rated')); ?> </a></li>
                                        <li class=""><a href="javascript:;" class="uppercase" data-href="new"><i class="icon-chevron-right pr-2"></i><?php echo e(__('New Arrival')); ?> </a></li>
                                        ...
                                        <li class="pt-3">
                                           <?php if($setting->is_attribute_search == 1): ?>
                                             ...
                                             <h3 class="widget-title uppercase"><?php echo e(__('Filter by')); ?> <?php echo e($attrubute->name); ?></h3>
                                             <section class="rounded">
                                               ...
                                               <div class="custom-control custom-checkbox">
                                                 ...
                                                 <label class="custom-control-label uppercase" for="<?php echo e($attrubute->id); ?><?php echo e($option->name); ?>" style="color:#505050 !important"><?php echo e($option->name); ?><span class="text-muted" ></span></label>
                                             </div> 
                                               <?php endif; ?>
                                        ...
                                        <li class="pt-2">
                                            ...
                                            <form class="price-range-slider" method="post" data-start-min="<?php echo e(request()->input('minPrice') ? request()->input('minPrice') : '0'); ?>" data-start-max="<?php echo e(request()->input('maxPrice') ? request()->input('maxPrice') : $setting->max_price); ?>" data-min="0" data-max="<?php echo e($setting->max_price); ?>" data-step="5">
                                                ...
                                                <div class="column">
                                                    <button class="btn btn-primary btn-sm uppercase" id="price_filter" type="button"><span><?php echo e(__('Filter')); ?></span></button>
                                                </div>
                                                <div class="column">
                                                    <div class="ui-range-values">
                                                    <div class="ui-range-value-min uppercase"  style="color:#505050 !important"><?php echo e(PriceHelper::setCurrencySign()); ?><span class="min_price"></span>
                                                        <input type="hidden">
                                                    </div>-
                                                    <div class="ui-range-value-max uppercase"  style="color:#505050 !important"><?php echo e(PriceHelper::setCurrencySign()); ?><span class="max_price"></span>
                                                        <input type="hidden">
                                                    </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="shop-sorting">
                                    <label for="sorting" class="uppercase"><?php echo e(__('Sort by')); ?>:</label>
                                    <select class="form-control uppercase" id="sorting" style="font-weight:700">
                                    <option value="" class="uppercase"><?php echo e(__('All Products')); ?></option>
                                    <option value="low_to_high" class="uppercase" <?php echo e(request()->input('low_to_high') ? 'selected' : ''); ?>><?php echo e(__('Low - High Price')); ?></option>
                                    <option value="high_to_low" class="uppercase" <?php echo e(request()->input('high_to_low') ? 'selected' : ''); ?>><?php echo e(__('High - Low Price')); ?></option>
                                    </select>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pxe\core\resources\views/front/catalog/index.blade.php ENDPATH**/ ?>
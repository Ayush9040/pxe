...
<div class="widget-categories mobile-cat">
    <ul id="category_list">
        ...
        <li class="has-children">
            <a class="category_search uppercase" href="<?php echo e(route('front.catalog').'?category='.$getcategory->slug); ?>"><?php echo e($getcategory->name); ?>
            ...
            <ul id="subcategory_list">
                ...
                <li class="">
                    <a class="subcategory uppercase" href="<?php echo e(route('front.catalog').'?subcategory='.$getsubcategory->slug); ?>"><?php echo e($getsubcategory->name); ?></a>
                    <ul id="childcategory_list">
                        ...
                        <li class="">
                            <a class="childcategory uppercase" href="<?php echo e(route('front.catalog').'?childcategory='.$getchildcategory->slug); ?>"><?php echo e($getchildcategory->name); ?></a>
                        </li>
...
<?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/includes/mobile-category.blade.php ENDPATH**/ ?>
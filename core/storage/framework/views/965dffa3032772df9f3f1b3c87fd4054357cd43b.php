      ...
      <div class="modal-dialog" >
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title uppercase"><?php echo e(__('Transaction Cash On Delivery')); ?></h6>
          ...
          <form action="<?php echo e(route('front.checkout.submit')); ?>" method="POST">
            ...
            <input type="hidden" name="state_id" value="<?php echo e(auth()->check() && auth()->user()->state_id ? auth()->user()->state_id : ''); ?>" class="state_id_setup uppercase">
            <div class="card-body">
              <p class="uppercase"><?php echo e(PriceHelper::GatewayText('cod')); ?></p>
            </div>
          <div class="modal-footer">
            <button class="btn btn-primary btn-sm uppercase" type="button" data-bs-dismiss="modal"><span><?php echo e(__('Cancel')); ?></span></button>
            <button class="btn btn-primary btn-sm uppercase" type="submit"><span><?php echo e(__('Cash On Delivery')); ?></span></button>
          </form>
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="mollie" tabindex="-1"  aria-hidden="true">
      <div class="modal-dialog" >
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title uppercase"><?php echo e(__('Transactions via Mollie')); ?></h6>
            <button class="close" type="button" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </div>
          <div class="modal-body">
            <p class="uppercase"><?php echo e(PriceHelper::GatewayText('mollie')); ?></p>
          </div>
          <div class="modal-footer">
            <form action="<?php echo e(route('front.checkout.submit')); ?>" method="POST">
              <?php echo csrf_field(); ?>
            ...
            <button class="btn btn-primary btn-sm uppercase" type="button" data-bs-dismiss="modal"><span><?php echo e(__('Cancel')); ?></span></button>
            <button class="btn btn-primary btn-sm uppercase" type="submit"><span><?php echo e(__('Checkout With Mollie')); ?></span></button>
          </form>
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="paypal" tabindex="-1"  aria-hidden="true">
      ...
      <div class="modal-dialog" >
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title uppercase"><?php echo e(__('Transactions via PayPal')); ?></h6>
            <button class="close uppercase" type="button" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </div>
          <div class="modal-body">
            <div class="card-body">
              <p class="uppercase"><?php echo e(PriceHelper::GatewayText('paypal')); ?></p>
              </div>
          </div>
          ...
          <div class="modal-footer">
            <button class="btn btn-primary btn-sm uppercase" type="button" data-bs-dismiss="modal"><span><?php echo e(__('Cancel')); ?></span></button>
            <button class="btn btn-primary btn-sm uppercase" type="submit"><span><?php echo e(__('Checkout With PayPal')); ?></span></button>
          </div>
        </div>
    ...
    <div class="modal fade" id="stripe" tabindex="-1"  aria-hidden="true">
      <div class="modal-dialog" >
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title uppercase"><?php echo e(__('Transactions via Stripe')); ?></h6>
            <button class="close" type="button" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </div>
          <div class="modal-body">
            <div class="card-body">
                  ...
                  <form class="interactive-credit-card row" action="<?php echo e(route('front.checkout.submit')); ?>" method="POST">
                    ...
                    <div class="form-group col-sm-12">
                      <input class="form-control uppercase" type="text" name="card" placeholder="<?php echo e(__('Card Number')); ?>" required>
                    </div>
                 <input type="hidden" name="payment_method" value="Stripe">
                 <input type="hidden" name="state_id" value="<?php echo e(auth()->check() && auth()->user()->state_id ? auth()->user()->state_id : ''); ?>" class="state_id_setup uppercase">
                    <div class="form-group col-sm-6">
                      <input class="form-control uppercase" type="text" name="month" placeholder="<?php echo e(__('Expitation Month')); ?>" required>
                    </div>
                    <div class="form-group col-sm-6">
                      <input class="form-control uppercase" type="text" name="year" placeholder="<?php echo e(__('Expitation Year')); ?>" required>
                    </div>
                    <div class="form-group col-sm-12">
                      <input class="form-control uppercase" type="text" name="cvc" placeholder="<?php echo e(__('CVV')); ?>" required>
                    </div>
          ...
          <div class="modal-footer">
            <button class="btn btn-primary btn-sm uppercase" type="button" data-bs-dismiss="modal"><span><?php echo e(__('Cancel')); ?></span></button>
            <button class="btn btn-primary btn-sm uppercase" type="submit"><span><?php echo e(__('Chekout With Stripe')); ?></span></button>
          </div>
        </form>
        </div>
      </div>
         ...
         <div class="modal fade" id="authorize" tabindex="-1"  aria-hidden="true">
          <div class="modal-dialog" >
            <div class="modal-content">
              <div class="modal-header">
                <h6 class="modal-title uppercase"><?php echo e(__('Transactions via Authorize.Net')); ?></h6>
                <button class="close" type="button" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              </div>
              <div class="modal-body">
                <div class="card-body">
                      ...
                      <form class="interactive-credit-card row" action="<?php echo e(route('front.authorize.submit')); ?>" method="POST">
                        ...
                        <p class="p-3 uppercase"><?php echo e(PriceHelper::GatewayText('authorize')); ?></p>
                    </div>
              </div>
              <div class="modal-footer">
                <button class="btn btn-primary btn-sm uppercase" type="button" data-bs-dismiss="modal"><span><?php echo e(__('Cancel')); ?></span></button>
...
<script>
  ...
  $(document).on('submit','#paystack_form',function(e){
    e.preventDefault();
       total = <?php echo e(PriceHelper::cartTotal(Session::get('cart'))); ?>;
...
<?php /**PATH /home/u384171748/domains/block55.in/public_html/core/resources/views/includes/checkout_modal.blade.php ENDPATH**/ ?>
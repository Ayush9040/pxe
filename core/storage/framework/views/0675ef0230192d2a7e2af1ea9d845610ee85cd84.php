...
<div class="padding-bottom-1x mb-1">
    <div class="">
      ...
      <div class="col-xxl-5">
          ...
          <div class="top-attributes_new">
              ...
              <div class="mb-3 select-size">
                            ...
                            <?php if($attribute->options->count() != 0): ?>
                                <div class="col-sm-12">
                                    <div class="">
                                    <!-- <label for="<?php echo e($attribute->name); ?>" class="color uppercase" style="font-size:25px"><?php echo e($attribute->name); ?></label> -->
                                    <!-- <select class="form-control attribute_option color spe_edition size" id="<?php echo e($attribute->name); ?>"  style="height:70px !important"> -->
                                        ...
                                        <span class="uppercase" value="<?php echo e($option->name); ?>" data-type="<?php echo e($attribute->id); ?>" data-href="<?php echo e($option->id); ?>" data-target="<?php echo e(PriceHelper::setConvertPrice($option->price)); ?>" style="font-size:12px; background-color: #fff; border-radius: 100px; padding: 10px; margin: 5px; color: #000;"><?php echo e($option->name); ?></span>
        ...
        <button class="btn btn-primary m-0 a-t-c-mr spe_edition uppercase" id="add_to_cart"><i class="icon-bag"></i><span class="fs-lg"><?php echo e(__('Add to Bag')); ?></span></button>
        ...
        <div class="col-xxl-7">
            <div class="details-page-top-right-content d-flex ">
                <div class="div w-100">
                    ...
                    <!-- <h4 class="mb-2 p-title-main uppercase"><?php echo e($item->name); ?></h4> -->
                    <div class="desc_product_pxe">
                    <h4 class="mb-2 p-title-main uppercase prod_name_pxe"><?php echo e($item->name); ?></h4>
                        <!-- <div class="rating-stars d-inline-block gmr-3">-->
                        <!--<?php echo renderStarRating($item->reviews->avg('rating')); ?>-->
                        <!--</div> -->
                        <!-- <?php if($item->is_stock()): ?>
                             <span class="text-success uppercase d-inline-block"><?php echo e(__('In Stock')); ?></span> 
                        <?php else: ?>
                             <span class="text-danger uppercase d-inline-block"><?php echo e(__('Out of stock')); ?></span> 
                        <?php endif; ?> -->

                        <span class="h3 d-block price-area" style="margin-bottom:1rem">
                    <?php if($item->previous_price != 0): ?>
                        <small class="d-block uppercase"><span class="rp">REGULAR PRICE </span> <span class="number_rp"><?php echo e(PriceHelper::setPreviousPrice($item->previous_price)); ?></span></small>
                    <?php endif; ?>
                    <span id="main_price" class="main-price uppercase"><span class="rp">DISCOUNTED PRICE </span><span class="number_rp"><?php echo e(PriceHelper::grandCurrencyPrice($item)); ?></span>
                    </span>
                    </div>
                    ...
                    <!-- <span class="h3 d-block price-area" style="margin-bottom:1rem">
                    <?php if($item->previous_price != 0): ?>
                        <small class="d-inline-block uppercase"><del><?php echo e(PriceHelper::setPreviousPrice($item->previous_price)); ?></del></small>
                    <?php endif; ?>
                    <span id="main_price" class="main-price uppercase"><?php echo e(PriceHelper::grandCurrencyPrice($item)); ?></span>
                    </span> -->

                    <p class="text-muted uppercase prod_details_pxe"><?php echo e($item->sort_details); ?> 
                      <!-- <a href="#details" class="scroll-to"><?php echo e(__('Read more')); ?></a> -->
                    </p>
             ...
             <!-- <span><?php echo e($sname); ?></span> -->
                          <span class="spec_button"><?php echo e($sdetail); ?></span>
                      </span>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                       <?php else: ?>
                       <span class="text-center">
                          <span colspan="2"><?php echo e(__('No Specifications')); ?></span>
                           </span>
                        <?php endif; ?>
                    </div>
...
<p class="prod-text uppercase">HYPOYARN IS OUR PROUD PROPRIETARY INNOVATION MADE OUT OF 100% ETHCIALLY SOURCED HEAVY WEIGHT 24S COTTON CUT AND SEWED BY INDIAN WORKMANSHIP TO PROVIDE AN OVERSIZED FIT PROVIDING OVERALL BLOCK55 MERCHANDISE AN ELITE LOOK.</p>
                    ...
                    <!-- <div class="col-12 mb-3 select-size">
                        ...
                        <?php if($attribute->options->count() != 0): ?>
                            <div class="col-sm-12">
                                ...
                                <select class="form-control attribute_option color spe_edition size" id="<?php echo e($attribute->name); ?>"  style="height:70px !important">
                                    <?php $__currentLoopData = $attribute->options->where('stock','!=','0'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option class="uppercase" value="<?php echo e($option->name); ?>" data-type="<?php echo e($attribute->id); ?>" data-href="<?php echo e($option->id); ?>" data-target="<?php echo e(PriceHelper::setConvertPrice($option->price)); ?>" style="font-size:20px"><?php echo e($option->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  </select>
                                </div>
                            </div>
    ...
    <button class="btn btn-primary m-0 a-t-c-mr spe_edition uppercase" id="add_to_cart"><i class="icon-bag"></i><span class="fs-lg"><?php echo e(__('Add to Cart')); ?></span></button>
                    ...
                    <!-- <div class="row margin-top-1x">
                        ...
                        <?php if($attribute->options->count() != 0): ?>
                            <div class="col-sm-6">
                                <div class="form-group">
                                <label for="<?php echo e($attribute->name); ?>" class="color"><?php echo e($attribute->name); ?></label>
                                <select class="form-control attribute_option color" class="color" id="<?php echo e($attribute->name); ?>">
                                    <?php $__currentLoopData = $attribute->options->where('stock','!=','0'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <!--<div class=" padding-top-3x mb-3" id="details">-->
            ...
            <!--<ul class="nav nav-tabs" role="tablist">-->
                <!--<li class="nav-item" role="presentation">-->
                    <!--<a class="nav-link active uppercase" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true"><?php echo e(__('Descriptions')); ?></a>-->
                <!--</li>-->
                <!--<li class="nav-item" role="presentation">-->
            ...
            <!--                <th class="text-uppercase text-medium uppercase"><?php echo e(__('Specifications')); ?></th>-->
            <!--                <td><span class="text-uppercase text-medium uppercase"><?php echo e(__('Descriptions')); ?></span></td>-->
            <!--            </tr>-->
            <!--            <?php if($sec_name): ?>-->
            <!--            <?php $__currentLoopData = array_combine($sec_name,$sec_details); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sname => $sdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
            <!--            <tr>-->
  ...
  <div class="relatedproduct-section container padding-bottom-3x mb-1 s-pt-30">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="section-title">
                <h2 class="h3"><?php echo e(__('OTHER RECOMMENDED PRODUCTS')); ?></h2>
            </div>
        </div>
    </div>
    <!-- Carousel-->
                    ...
                    <div class="slider-item">
                        <div class="product-card">
                            ...
                            <div style="justify-content:center;display:flex">
                                <button type="button" class="quick_add_btn btn btn-primary add_to_single_cart" href="javascript:;"  data-target="<?php echo e($related->id); ?>" >QUICK ADD</button>
                            </div>
                            </div>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pxe\core\resources\views/front/catalog/product.blade.php ENDPATH**/ ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="reg-ln" style="display:block;"><?php echo e(__('Category')); ?></label>
                  <!-- <input class="form-control" type="text" name="last_name" placeholder="<?php echo e(__('Last Name')); ?>" id="reg-ln" value="<?php echo e(old('last_name')); ?>"> -->
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/raj/Desktop/dev/php/jkkmecom/core/resources/views/user/auth/login.blade.php ENDPATH**/ ?>
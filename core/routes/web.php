...
// 
        ...
        Route::group(['middleware' => 'permissions:Manage Orders'], function () {
            ...
            //------------ franchise ------------
            // Route::get('/franchise', 'Back\FranchiseController@pos')->name('back.franchise.index');
            Route::get('franchise/{$id}', 'Back\FranchiseController@show')->name('back.franchise.show');

            Route::resource('/franchise', 'Back\FranchiseController', ['as' => 'back', 'except' => ['create', 'store', 'edit']]);
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::get('/{slug}', 'Front\FrontendController@page')->name('front.page');
         ...
         // ----------- FORM CONTACT ----------//
         Route::get('/front/form','Front\FrontendController@formcontact')->name('front.form');
         Route::post('/front/form','Front\FrontendController@formcontroller');  
         Route::get('/front/updateform','Front\FrontendController@updateformcontact');
         Route::post('/front/form','Front\FrontendController@formcontroller');  


        // ************************************ FRONTEND ENDS**********************************************
         // ----------- FAQ PRIVACY AND REPLACEMENT  ----------//

         Route::get('/front/privacy','Front\FrontendController@privacy')->name('front.privacy');

         Route::get('/front/replacement','Front\FrontendController@replacement')->name('front.replacement');

        // ************************************ FAQ PRIVACY AND REPLACEMENT END**********************************************
